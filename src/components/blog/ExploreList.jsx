        ...
        <div className="row mt-4">
            ...
            <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
                <div className='card-flex_explore'>
                    ...
                    <div className='content_explore_wrap'>
                        <Link href='#'> Marketing  <Image src={ExploreArrow}/></Link>
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit Quisque aliquam tristique. </p>
                    </div>
                </div>
            </div>
            ...
            <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
                <div className='card-flex_explore'>
                    <Image src={Leftseo}/>
                    <div className='content_explore_wrap'>
                        <Link href='#'> Seo  <Image src={ExploreArrow}/></Link>
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit Quisque aliquam tristique. </p>
                    </div>
                </div>
            </div>
            ...
            <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
                <div className='card-flex_explore'>
                    <Image src={Leftppc}/>
                    <div className='content_explore_wrap'>
                        <Link href='#'> PPC  <Image src={ExploreArrow}/></Link>
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit Quisque aliquam tristique. </p>
                    </div>
                </div>
            </div>
            ...
            <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
                <div className='card-flex_explore'>
                    ...
                    <div className='content_explore_wrap'>
                        <Link href='#'> Social Media  <Image src={ExploreArrow}/></Link>
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit Quisque aliquam tristique. </p>
                    </div>
                </div>
            </div>
            ...
            <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
                <div className='card-flex_explore'>
                    ...
                    <div className='content_explore_wrap'>
                        <Link href='#'> Web Design  <Image src={ExploreArrow}/></Link>
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit Quisque aliquam tristique. </p>
                    </div>
                </div>
            </div>
            ...
            <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4'>
                <div className='card-flex_explore'>
                    ...
                    <div className='content_explore_wrap'>
                        <Link href='#'> Internet  <Image src={ExploreArrow}/></Link>
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit Quisque aliquam tristique. </p>
                    </div>
                </div>
            </div>
